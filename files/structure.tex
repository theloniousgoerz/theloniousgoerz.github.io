...
\sectionfont{\ExtraLarge {11pt}{11pt}\selectfont} % Set font options for sections
...
\setlength{\marginparsep}{2pt} % Move the margin content closer to the text
%s\reversemarginpar % Margin text to be output into the left margin instead of the default right margin
